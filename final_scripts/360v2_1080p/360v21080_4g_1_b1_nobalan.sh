...
for scene in ${SCENE[@]}; do
    for bsz in ${BSZ[@]}; do
        ...
        torchrun --standalone --nnodes=1 --nproc-per-node=4 /global/homes/j/jy-nyu/gaussian-splatting/train.py \
            ...
            --iterations 50000 \
            --log_interval 250 \
            --log_folder /pscratch/sd/j/jy-nyu/final_expes/360v21080_4g_1b_nobalan/$expe_name \
            --model_path /pscratch/sd/j/jy-nyu/final_expes/360v21080_4g_1b_nobalan/$expe_name \
