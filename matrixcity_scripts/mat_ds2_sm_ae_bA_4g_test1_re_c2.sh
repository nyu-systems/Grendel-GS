...
# bash matrixcity_scripts/mat_ds2_sm_ae_bA_4g_test1_re_c1.sh

expe_name="mat_ds2_sm_ae_bA_4g_test1_re_c2"
...
torchrun --standalone --nnodes=1 --nproc-per-node=4 /global/homes/j/jy-nyu/gaussian-splatting/train.py \
    ...
    --save_iterations 7000 15000 15500 16000 16500 17000 17500 18000 15000 19000 19500 20000 30000 40000 50000 80000 100000 120000 150000 170000 200000 \
    --checkpoint_iterations 7000 15000 20000 30000 40000 50000 80000 100000 120000 150000 170000 200000 \
    --start_checkpoint /pscratch/sd/j/jy-nyu/mat_expes/mat_ds2_sm_ae_bA_4g_test1_re/checkpoints/14997 \
