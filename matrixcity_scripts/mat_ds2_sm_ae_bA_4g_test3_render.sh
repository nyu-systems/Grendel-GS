...
expe_name="mat_ds2_sm_ae_bA_4g_test3"

# echo "connecting to head_node_ip: $head_node_ip, port: $port"

# iterations=(199997 79997 49997 29997)
iterations=(6997 14997)
# 7000 15000 30000 50000 80000 100000 120000 150000 170000 200000
