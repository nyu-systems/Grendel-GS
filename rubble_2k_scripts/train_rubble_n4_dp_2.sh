...
# bash rubble_2k_scripts/train_rubble_n4_dp_2.sh > r0.log 2> r0.err
# bash rubble_2k_scripts/train_rubble_n4_dp_2.sh > r1.log 2> r1.err
# bash rubble_2k_scripts/train_rubble_n4_dp_2.sh > r2.log 2> r2.err
# bash rubble_2k_scripts/train_rubble_n4_dp_2.sh > r3.log 2> r3.err
