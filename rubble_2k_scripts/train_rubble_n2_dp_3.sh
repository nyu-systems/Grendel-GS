...
torchrun \
    ...
    --iterations 200000 \
    --log_interval 250 \
    --log_folder /pscratch/sd/j/jy-nyu/running_expes/rubble_2k_n2_dp_3 \
    --model_path /pscratch/sd/j/jy-nyu/running_expes/rubble_2k_n2_dp_3 \
...
# bash rubble_2k_scripts/train_rubble_n2_dp_3.sh > rubble_2k_n2_dp_3_node0.log 2> rubble_2k_n2_dp_3_node0.err
# bash rubble_2k_scripts/train_rubble_n2_dp_3.sh > rubble_2k_n2_dp_3_node1.log 2> rubble_2k_n2_dp_3_node1.err
