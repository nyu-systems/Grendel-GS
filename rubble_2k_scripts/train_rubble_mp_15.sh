...
torchrun --standalone --nnodes=1 --nproc-per-node=4 /global/homes/j/jy-nyu/gaussian-splatting/train.py \
    ...
    --iterations 200000 \
    --log_interval 250 \
    --log_folder /pscratch/sd/j/jy-nyu/running_expes/rubble_2k_mp_15 \
    --model_path /pscratch/sd/j/jy-nyu/running_expes/rubble_2k_mp_15 \
    ...
    --checkpoint_iterations 7000 30000 50000 80000 100000 120000 150000 180000 200000 \
