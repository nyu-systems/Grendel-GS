...
port=27709
rid=104
expe_name="rub4k_n4_test"

echo "connecting to head_node_ip: $head_node_ip, port: $port"

# nid[003080-003081,003084-003085]

# bash gaussian-splatting/rubble_4k_scripts/train_rub4k_n4_test.sh
# chmod 777 gaussian-splatting/rubble_4k_scripts/train_rub4k_n4_test.sh
...
torchrun \
    ...
    --checkpoint_iterations 200 7000 30000 50000 80000 100000 120000 150000 170000 200000 \
