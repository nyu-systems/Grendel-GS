...
# bash /global/homes/j/jy-nyu/gaussian-splatting/last_scripts/mball2/mball2_16g_7.sh

source ~/zhx.sh

rid=78
head_node_ip="nid002045"
port=277$rid

expe_name="mball2_16g_7"
log_file="/pscratch/sd/j/jy-nyu/last_scripts/mball2/$expe_name.log"
err_file="/pscratch/sd/j/jy-nyu/last_scripts/mball2/$expe_name.err"
...
torchrun \
    ...
    --iterations 300000 \
    --log_interval 250 \
    --log_folder /pscratch/sd/j/jy-nyu/last_scripts/mball2/$expe_name \
    --model_path /pscratch/sd/j/jy-nyu/last_scripts/mball2/$expe_name \
    ...
    --save_iterations 7000 100000 200000 300000 \
    --checkpoint_iterations 7000 100000 200000 300000 \
