...
# bash gaussian-splatting/final_scripts/mball2_16g_4.sh
# bash /global/homes/j/jy-nyu/gaussian-splatting/last_scripts/mball2/mball2_16g_4.sh
source ~/zhx.sh
