...
for scene in ${SCENE[@]}; do
    for bsz in ${BSZ[@]}; do
        ...
        torchrun --standalone --nnodes=1 --nproc-per-node=4 /global/homes/j/jy-nyu/gaussian-splatting/train.py \
            ...
            --iterations 50000 \
            --log_interval 250 \
            --log_folder /pscratch/sd/j/jy-nyu/last_scripts/mip360_1080p/4g_1b_noimgbalan/$expe_name \
            --model_path /pscratch/sd/j/jy-nyu/last_scripts/mip360_1080p/4g_1b_noimgbalan/$expe_name \
