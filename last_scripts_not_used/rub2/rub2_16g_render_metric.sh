...
# bash /global/homes/j/jy-nyu/gaussian-splatting/last_scripts/rub2/rub2_16g_render_metric.sh
...
for name in ${EXPE_NAMES[@]}; do
    for iter in ${CHECKPOINTS[@]}; do
        ...
        python /global/homes/j/jy-nyu/gaussian-splatting/render.py \
            ...
            --model_path "/pscratch/sd/j/jy-nyu/last_scripts/rub2/${name}" \
            --iteration $iter \
            --distributed_load \
            --skip_train \
            --llffhold 83
        ...
        python /global/homes/j/jy-nyu/gaussian-splatting/metrics.py \
            --mode test \
            --model_paths "/pscratch/sd/j/jy-nyu/last_scripts/rub2/${name}"
