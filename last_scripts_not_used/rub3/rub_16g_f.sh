...
# bash /global/homes/j/jy-nyu/gaussian-splatting/last_scripts/rub3/rub_16g_f.sh
...
torchrun \
    ...
    --iterations 200000 \
    --log_interval 250 \
    --log_folder /pscratch/sd/j/jy-nyu/last_scripts/rub3/$expe_name \
    --model_path /pscratch/sd/j/jy-nyu/last_scripts/rub3/$expe_name \
